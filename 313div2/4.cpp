...
bool func(string a,string b)
{
    ...
    {
        ll length=a.size()/2;
        if(func(a.substr(0,length),b.substr(length,length))&&func(a.substr(length,length),b.substr(0,length))||func(a.substr(0,length),b.substr(0,length))&&func(a.substr(length,length),b.substr(length,length))) 
        	return true;
        else
         return false;
    }
